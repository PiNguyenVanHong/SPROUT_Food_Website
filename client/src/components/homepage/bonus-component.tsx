    ...
    <div className="lg:my-20">
      <div className="max-w-7xl w-full mx-auto flex flex-col justify-start border-t-2 border-background-darker pt-10 lg:pt-20">
        <div className="flex items-center gap-4">
          <Trophy size={32} />
          <h1 className="text-xl lg:text-3xl font-semibold">Bonus program</h1>
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mt-10 lg:mt-20">
          <div className="bg-white px-10 py-8 rounded-xl flex flex-col items-center justify-between shrink-0 grow-0 shadow-lg">
            <div className="w-full flex flex-col lg:flex-row items-center justify-between mb-7 lg:mb-10">
              <ProgressCircle progress={5} size={200} />
              <div className="flex w-full lg:w-auto lg:flex-1 lg:flex-col items-center gap-1 lg:gap-3 mt-5 lg:mt-0 lg:pl-10 font-medium">
                <div className="w-full flex items-center lg:justify-between gap-2 lg:gap-0">
                  <span>Level:</span>
                  <span>1</span>
                </div>
                <div className="w-full flex items-center lg:justify-between gap-2">
                  <span className="truncate">Not enough <span className="hidden lg:inline-block"> to 10%:</span></span>
                  <span>$74</span>
                </div>
              </div>
            </div>
            <SliderCustom isPrice={false} initialColor="foreground-red" />
          </div>
