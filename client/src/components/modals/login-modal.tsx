...
const LoginModal = () => {
  ...
  return (
    <Dialog open={isModalOpen} onOpenChange={handleClose}>
      <DialogContent className="max-w-md lg:max-w-4xl bg-white text-black p-0 overflow-hidden">
        <DialogHeader>
          <DialogTitle className="text-3xl font-bold px-8 pt-10">
            Create account
          </DialogTitle>
        </DialogHeader>
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)}>
                ...
                <div className="flex flex-col items-center bg-background-darker px-8 py-10">
                  <div className="w-full flex flex-col lg:flex-row items-center gap-1 lg:gap-4">
                    ...
                    <div className="flex justify-between items-stretch space-x-4">
                      ...
                      >
                        <svg
                          className="w-4 fill-[#E45959] group-hover:fill-white"
                      ...
                      >
                        <svg
                          className="h-4 fill-[#3B82F6] group-hover:fill-white"
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 320 512"
                        >
                          <path
